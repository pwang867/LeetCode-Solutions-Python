...
def __init__(self, input_matrix=None, is_profit_matrix=False):
    ...
    def calculate(self, input_matrix=None, is_profit_matrix=False):
        ...
        # if the total covered rows+columns is not equal to the matrix size 
        # then adjust it by min uncovered num (m).
        ...
        while len(self._results) != expected_results:
            ...
            # If number of zeros in the matrix is zero before 
            # finding all the results then an error has occurred.
