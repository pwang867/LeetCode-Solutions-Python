# greedy
# greedy point 1: sort by end time
# greedy point 2: delete the longest course if deadline is not met
...
A course should be taken continuously for t days and must be finished before 
